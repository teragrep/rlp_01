...
public abstract class AbstractRelpFrame {
     ...
     * Constructor.
     * 
     * @param command    Type of command (e.g. "open", "syslog", etc.).
     * @param dataLength Length of the data in the message.
     */
     ...
     * @param command    Type of command (list of possibilities in RelpCommand.java).
     * @param dataLength Length of the data in the message.
     */
