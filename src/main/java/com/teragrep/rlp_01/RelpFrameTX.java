...
/**
 * This is the frame for transmitting RELP messages. A RELP message as defined in the spec.: Binary PAYLOAD (DATA in the
 * BNF) is supported.
 */
public class RelpFrameTX extends AbstractRelpFrame implements Writeable {
    ...
    /**
     * Write the whole RELP message: HEADER DATA TRAILER to the byte buffer.
     */
    ...
    /**
     * Writes the DATA part of the RELP message into the given buffer with a space byte before the actual data.
     * 
     ...
     *
     * @param dst Shouldn't happen for US-ASCII..
     */
    ...
    public String toString() {
        return this.transactionNumber + " " + this.command + " " + this.dataLength + " "
                + (this.data != null ? new String(this.data, StandardCharsets.UTF_8) : "");
    }
}
