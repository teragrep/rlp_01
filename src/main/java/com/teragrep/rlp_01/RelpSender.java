...
/**
 * A RELP message sender interface that specifies sending of a window of messages in a batch.
 */
public interface RelpSender {
     ...
     * 
     * @param hostname Hostname of IP address of the server.
     * @param port     Port of the server.
     * @throws IOException
     * @throws IllegalStateException If the connection was already made.
     */
     ...
     * 
     * @throws IOException
     * @throws IllegalStateException If the session was already closesd.
     */
